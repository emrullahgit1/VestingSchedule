// src/lib.rs
/*
 * Core library for VestingSchedule
 */
...
#[derive(Debug)]
pub struct VestingScheduleProcessor {
    verbose: bool,
    processed_count: usize,
}

impl VestingScheduleProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting VestingSchedule processing");
    
    let mut processor = VestingScheduleProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = VestingScheduleProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = VestingScheduleProcessor::new(false);
